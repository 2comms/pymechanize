...
Runs a local server to point the pymechanize functional tests at.  Example:
...
MECHANIZE_HTML = html()
ROOT_HTML = html("pymechanize")
RELOAD_TEST_HTML = """\
<html>
<head><title>Title</title></head>
<body>

<a href="/pymechanize">near the start</a>
...
<a href="/pymechanize">near the end</a>
...
<html>
<head>
<title>pymechanize Referer (sic) test page</title>
</head>
<body>
<p>This page exists to test the Referer functionality of <a href="/pymechanize">pymechanize</a>.
...
def main(argv):
    ...
    root = Page()
    root.text = ROOT_HTML
    pymechanize = make_page(root, "pymechanize", MECHANIZE_HTML)
    ...
    make_leaf_page(test_fixtures, "pymechanize_reload_test.html",
                   RELOAD_TEST_HTML)
    ...
    make_leaf_page(pymechanize, "example.html", example_html)
