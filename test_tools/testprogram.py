...
from pymechanize import rfc3986
from pymechanize import testcase as _testcase
...
class TwistedServerProcess(ServerProcess):
    ...
    def __init__(self, uri, name, log=False):
        ...
        self.uri = uri
        authority = rfc3986.urlsplit(uri)[1]
...
class TwistedFtpServerProcess(ServerProcess):
    ...
    def __init__(self, name, port=2121, log=False):
        ...
        ServerProcess.__init__(self, path, name)
        self._temp_maker = _testcase.TempDirMaker()
...
class TestProgram(unittest.TestProgram):
    ...
    def parseArgs(self, argv):
        ...
        if options.meld:
            _testcase.GoldenTestCase.run_meld = True
