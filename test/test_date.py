...
class DateTimeTests(TestCase):
    ...
    def test_time2isoz(self):
        from pymechanize.util import time2isoz
    ...
    def test_parse_date(self):
        from pymechanize.util import http2time
    ...
    def test_http2time_formats(self):
        from pymechanize.util import http2time, time2isoz
    ...
    def test_http2time_garbage(self):
        ...
        for test in [
            ...
            if http2time(test) is not None:
                ...
                print("http2time(test) %s" % http2time(test))
                bad = True
