...
import pymechanize.headersutil
...
class IsHtmlTests(TestCase):
    ...
    def test_is_html(self):
        def check(headers, extension, is_html):
            ...
            self.assertEqual(
                pymechanize.headersutil.is_html(headers, url, allow_xhtml),
                is_html)
...
class HeaderTests(TestCase):
    ...
    def test_join_header_words(self):
        from pymechanize.headersutil import join_header_words
    ...
    def test_split_header_words(self):
        from pymechanize.headersutil import split_header_words
        ...
        for arg, expect in tests:
            try:
                ...
                import traceback, io.StringIO as StringIO
                f = StringIO.StringIO()
...
""" % (arg, expect, result)
    ...
    def test_roundtrip(self):
        from pymechanize.headersutil import split_header_words, join_header_words
