...
This is urllib2's tests (most of which came from pymechanize originally), plus
...
from pymechanize.http import parse_head
from pymechanize.response import test_response
from pymechanize import (HTTPRedirectHandler,
     HTTPEquivProcessor, HTTPRefreshProcessor,
     HTTPCookieProcessor, HTTPRefererProcessor,
     HTTPErrorProcessor, HTTPHandler)
from pymechanize import OpenerDirector, build_opener, Request
from pymechanize.urllib_fork import AbstractHTTPHandler
from pymechanize.util import write_file, get_headers

import pymechanize.response
import pymechanize.sockettimeout as _sockettimeout
import pymechanize.testcase
import pymechanize.urllib_fork


# # from logging import getLogger, DEBUG
# # l = getLogger("pymechanize")
# # l.setLevel(DEBUG)
...
class TrivialTests(pymechanize.testcase.TestCase):

    def test_trivial(self):
        # A couple trivial tests
        self.assertRaises(ValueError, pymechanize.urlopen, 'bogus url')
...
#             fname = fname.translate(string.maketrans("/.", "./"))
        ...
        f = pymechanize.urlopen(file_url)
    ...
    def test_parse_http_list(self):
        ...
        for string, list in tests:
            self.assertEquals(pymechanize.urllib_fork.parse_http_list(string),
                              list)
...
def test_password_manager(self):
    """
    >>> mgr = pymechanize.HTTPPasswordMgr()
...
class MockHandler:
    ...
    def handle(self, fn_name, action, *args, **kwds):
        ...
        if action is None:
            ...
            raise pymechanize.URLError("blah")
        assert False
    def close(self): pass
...
class MockHTTPHandler(pymechanize.BaseHandler):
    ...
    def http_open(self, req):
        import copy
        from pymechanize.util import get_headers
        self.requests.append(copy.deepcopy(req))
        if self._count == 0:
            self._count = self._count + 1
            name = "Not important"
            msg = get_headers(StringIO(self.headers))
...
class OpenerDirectorTests(unittest.TestCase):
    ...
    def test_badly_named_methods(self):
        ...
        from pymechanize import URLError
        ...
        o.add_handler(pymechanize.UnknownHandler())
    ...
    def test_raise(self):
        ...
        req = Request("http://example.com/")
        self.assertRaises(pymechanize.URLError, o.open, req)
...
# #         #  but should really be tested anyway...
    ...
    def test_http_error_raised(self):
        ...
        o = pymechanize.OpenerDirector()
        o.add_handler(pymechanize.HTTPErrorProcessor())
        o.add_handler(pymechanize.HTTPDefaultErrorHandler())
        class HTTPHandler(AbstractHTTPHandler):
            def http_open(self, req):
                return response.test_response(code=302)
        o.add_handler(HTTPHandler())
        self.assertRaises(pymechanize.HTTPError, o.open, "http://example.com/")
...
class MockPasswordManager2:
    ...
    def find_user_password(self, realm, authuri):
        ...
        self.target_url = authuri
        return self.user, self.password
MockPasswordManager = MockPasswordManager2

class HandlerTests(pymechanize.testcase.TestCase):
    ...
    def test_ftp(self):
        ...
        class NullFTPHandler(pymechanize.FTPHandler):
            def __init__(self, data): self.data = data
    ...
    def test_file(self):
        ...
        for url in [
            ...
            write_file(temp_file, towrite)
            self.assertRaises(pymechanize.URLError, h.file_open, Request(url))
...
# XXXX bug: fails with OSError, should be URLError
            ...
            except (pymechanize.URLError, OSError):
    ...
    def test_http(self):
        ...
        self.assertRaises(pymechanize.URLError, h.do_open, http, req)
    ...
    def test_errors(self):
        ...
        r = pymechanize.response.test_response()
        newr = h.http_response(req, r)
        self.assertTrue(r is newr)
        self.assertTrue(not hasattr(o, "proto"))  # o.error not called
        r = pymechanize.response.test_response(code=202, msg="Accepted")
        newr = h.http_response(req, r)
        self.assertTrue(r is newr)
        self.assertTrue(not hasattr(o, "proto"))  # o.error not called
        r = pymechanize.response.test_response(code=206, msg="Partial content")
        newr = h.http_response(req, r)
        self.assertTrue(r is newr)
        self.assertTrue(not hasattr(o, "proto"))  # o.error not called
        # anything else calls o.error (and MockOpener returns None, here)
        r = pymechanize.response.test_response(code=502, msg="Bad gateway")
    ...
    def test_robots(self):
        # XXX useragent
        from pymechanize import HTTPRobotRulesProcessor
        opener = OpenerDirector()
        ...
        try:
            h.http_request(req)
        except pymechanize.HTTPError as e:
    ...
    def test_redirected_robots_txt(self):
        ...
        import pymechanize
        from pymechanize import build_opener, HTTPHandler, \
    ...
    def test_http_equiv(self):
        ...
        url = "http://example.com/"
        req = Request(url)
        r = pymechanize.response.make_response(data, headers, url, 200, "OK")
        newr = h.http_response(req, r)
    ...
    def test_redirect_bad_uri(self):
        ...
        from pymechanize.response import test_html_response
        from_url = "http://example.com/a.html"
    ...
    def test_cookie_redirect(self):
        ...
        from pymechanize import CookieJar, build_opener, HTTPHandler, \
    ...
    def test_proxy(self):
        o = OpenerDirector()
        ph = pymechanize.ProxyHandler(dict(http="proxy.example.com:3128"))
        o.add_handler(ph)
        meth_spec = [
    ...
    def test_proxy_no_proxy(self):
        ...
        o = OpenerDirector()
        ph = pymechanize.ProxyHandler(dict(http="proxy.example.com"))
        o.add_handler(ph)
    ...
    def test_proxy_custom_proxy_bypass(self):
        self.monkey_patch_environ("no_proxy",
                                  pymechanize.testcase.MonkeyPatcher.Unset)
    ...
    def test_proxy_https(self):
        o = OpenerDirector()
        ph = pymechanize.ProxyHandler(dict(https='proxy.example.com:3128'))
        o.add_handler(ph)
        meth_spec = [
    ...
    def test_basic_auth(self, quote_char='"'):
        ...
        auth_handler = pymechanize.HTTPBasicAuthHandler(password_manager)
    ...
    def test_proxy_basic_auth(self):
        ...
        password_manager = MockPasswordManager()
        auth_handler = pymechanize.ProxyBasicAuthHandler(password_manager)
        realm = "ACME Networks"
        http_handler = MockHTTPHandler(
    ...
    def test_basic_and_digest_auth_handlers(self):
        ...
        class TestDigestAuthHandler(pymechanize.HTTPDigestAuthHandler):
            def http_error_401(self, *args, **kwds):
                self.parent.record("digest")
                pymechanize.HTTPDigestAuthHandler.http_error_401(self,
                                                             *args, **kwds)
        class TestBasicAuthHandler(pymechanize.HTTPBasicAuthHandler):
            def http_error_401(self, *args, **kwds):
                self.parent.record("basic")
                pymechanize.HTTPBasicAuthHandler.http_error_401(self,
                                                            *args, **kwds)
...
class HeadParserTests(unittest.TestCase):
    ...
    def test(self):
        # XXX XHTML
        from pymechanize import HeadParser
        htmls = [
...
class FunctionTests(unittest.TestCase):
    ...
    def test_build_opener(self):
        ...
        class FooHandler(pymechanize.BaseHandler):
            def foo_open(self): pass
        class BarHandler(pymechanize.BaseHandler):
