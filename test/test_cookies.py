...
from pymechanize import Request
...
class CookieJarInterfaceTests(unittest.TestCase):
    ...
    def test_add_cookie_header(self):
        from pymechanize import CookieJar
    ...
    def test_unverifiable(self):
        from pymechanize.clientcookie import request_is_unverifiable
        # .unverifiable was added in pymechanize, .is_unverifiable() later got
...
# #   that...
    ...
    def test_policy(self):
        import pymechanize
        policy = pymechanize.DefaultCookiePolicy()
        jar = pymechanize.CookieJar()
        jar.set_policy(policy)
        self.assertEquals(jar.get_policy(), policy)

    def test_make_cookies_doesnt_change_jar_state(self):
        from pymechanize import CookieJar, Request, Cookie
        from pymechanize.util import time2netscape
    ...
    def test_domain_return_ok(self):
        ...
        import pymechanize
        pol = pymechanize.DefaultCookiePolicy()
    ...
    def test_missing_name(self):
        from pymechanize import MozillaCookieJar, lwp_cookie_str
    ...
    def test_rfc2109_handling(self):
        ...
        from pymechanize import CookieJar, DefaultCookiePolicy
    ...
    def test_ns_parser(self):
        from pymechanize import CookieJar
        from pymechanize.clientcookie import DEFAULT_HTTP_PORT
    ...
    def test_escape_path(self):
        from pymechanize.clientcookie import escape_path
        cases = [
            # quoted safe
    ...
    def test_request_path(self):
        from pymechanize.clientcookie import request_path
        # with parameters
    ...
    def test_request_port(self):
        from pymechanize.clientcookie import request_port, DEFAULT_HTTP_PORT
    ...
    def test_request_host_lc(self):
        from pymechanize.clientcookie import request_host_lc
    ...
    def test_effective_request_host(self):
        from pymechanize import effective_request_host
        self.assertEquals(
    ...
    def test_is_HDN(self):
        from pymechanize._clientcookie import is_HDN
    ...
    def test_reach(self):
        from pymechanize.clientcookie import reach
    ...
    def test_domain_match(self):
        from pymechanize.clientcookie import domain_match, user_domain_match
...
# #         assert len(c) == 2
    ...
    def test_domain_block(self):
        ...
        # import logging; logging.getLogger("pymechanize").setLevel(logging.DEBUG)
    ...
    def test_missing_final_slash(self):
        ...
        from pymechanize import CookieJar, Request, DefaultCookiePolicy
        url = "http://www.acme.com"
...
# #         print h
    ...
    def test_Cookie_iterator(self):
        from pymechanize import CookieJar, Cookie, DefaultCookiePolicy
    ...
    def test_parse_ns_headers(self):
        from pymechanize.headersutil import parse_ns_headers
    ...
    def test_bad_cookie_header(self):
        ...
        def cookiejar_from_cookie_headers(headers):
            from pymechanize import CookieJar, Request
            c = CookieJar()
            req = Request("http://www.example.com/")
...
class CookieJarPersistenceTests(TempfileTestMixin, unittest.TestCase):
    ...
    def test_firefox3_cookiejar_restore(self):
        try:
            from pymechanize import Firefox3CookieJar
        except ImportError:
            pass
        else:
            from pymechanize import DefaultCookiePolicy
...
<Cookie fooc=bar for .www.foo.com/>""")
    ...
    def test_mozilla_cookiejar(self):
        ...
        from pymechanize import MozillaCookieJar, DefaultCookiePolicy
        filename = tempfile.mktemp()
        c = MozillaCookieJar(filename,
    ...
    def test_mozilla_cookiejar_embedded_tab(self):
        from pymechanize import MozillaCookieJar
        filename = tempfile.mktemp()
        fh = open(filename, "w")
        try:
            fh.write(
    ...
    def test_mozilla_cookiejar_initial_dot_violation(self):
        from pymechanize import MozillaCookieJar, LoadError
        filename = tempfile.mktemp()
        fh = open(filename, "w")
        try:
            fh.write(
...
class LWPCookieTests(unittest.TestCase, TempfileTestMixin):
    ...
    def test_rejection(self):
        ...
        from pymechanize import LWPCookieJar, DefaultCookiePolicy
