...
class PullParserTests(TestCase):
    from pymechanize.pullparser import PullParser, TolerantPullParser
...
"""  # "
    ...
    def test_encoding(self):
        # from pymechanize import _pullparser
...
#        response = urllib.addinfourl(f, {"content-type": "text/html; charset=XXX"}, req.get_full_url())
    ...
    def _test_get_token(self, parser_class, tolerant):
        ...
        p = parser_class(f)
        from pymechanize.pullparser import NoMoreTokensError
        self.assertEqual(
            p.get_token(), ("decl",
...
#        sys.exit()
    ...
    def test_token_eq(self):
        from pymechanize.pullparser import Token
        for (a, b) in [
