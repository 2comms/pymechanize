...
class UserAgentTests(TestCase):
    ...
    def test_set_handled_schemes(self):
        ...
        class TestUserAgent(pymechanize.UserAgent):
            default_schemes = ["http"]
            default_others = []
            default_features = []
            handler_classes = pymechanize.UserAgent.handler_classes.copy()
        ...
        req = pymechanize.Request("blah://example.com/")
        r = ua.open(req)
