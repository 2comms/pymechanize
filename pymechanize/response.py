...
class closeable_response:
    ...
    Only supports responses returned by pymechanize.HTTPHandler.
...
def seek_wrapped_response(response):
    ...
    Accepts responses from both pymechanize and urllib2 handlers.
...
def upgrade_response(response):
    ...
    # _Util.closeable_response as returned by e.g. pymechanize.HTTPHandler
    try:
        code = response.code
