...
from .clientcookie import CookieJar, Cookie, MappingIterator
from .util import isstringlike, experimental
...
class Firefox3CookieJar(CookieJar):
    ...
    policy: an object satisfying the pymechanize.CookiePolicy interface
