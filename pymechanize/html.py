...
from pymechanize import sgmllib_copy as sgmllib

# import _beautifulsoup
from bs4 import BeautifulSoup, Tag
from . import form
from .headersutil import split_header_words, is_html as _is_html
from . import request, rfc3986
...
class Link:
    def __init__(self, base_url, url, text, tag, attrs):
        ...
        self.absolute_url = rfc3986.urljoin(base_url, url)
    ...
    def links(self):
        ...
        try:
            for token in p.tags(*(self.urltags.keys() + ["base"])):
                ...
                url = rfc3986.clean_url(url, encoding)
                if tag == "a":
...
class FormsFactory:
    ...
    def __init__(self,
        ...
        if form_parser_class is None:
            form_parser_class = form.FormParser
    ...
    def forms(self):
        ...
        forms = form.ParseResponseEx(
            self._response,
            select_default=self.select_default,
            form_parser_class=self.form_parser_class,
            request_class=self.request_class,
            encoding=encoding,
            _urljoin=rfc3986.urljoin,
            _urlparse=rfc3986.urlsplit,
            _urlunparse=rfc3986.urlunsplit,
            )
...
class RobustFormsFactory(FormsFactory):
    def __init__(self, *args, **kwds):
        ...
        if args.form_parser_class is None:
            args.form_parser_class = form.RobustFormParser
...
class Factory:
    ...
    def set_request_class(self, request_class):
        """Set request class (pymechanize.Request by default).
    ...
    def set_response(self, response):
        ...
        objects returned by pymechanize.urlopen().
    ...
    def forms(self):
        ...
        Raises pymechanize.ParseError on failure.
        """
    ...
    def links(self):
        """Return iterable over pymechanize.Link-like objects.
