...
from .clientcookie import FileCookieJar, CookieJar, Cookie, \
...
def epoch_time_offset_from_win32_filetime(filetime):
    ...
    pymechanize expects time in 32-bit value expressed in seconds since the
    epoch (Jan 01 1970).
...
class MSIECookieJar(MSIEBase, FileCookieJar):
    ...
    opener = pymechanize.build_opener(pymechanize.HTTPCookieProcessor(cj))
